...
#define TYPE_17_DEFAULT_SIZE  0x28;   // Version 2.8 size (from the SMBIOS Specification)
...
typedef struct {
  ...
  // Add for smbios 3.2
  //
  UINT8                             MemoryTechnology;     ///< The enumeration value from MEMORY_TECHNOLOGY.
  MEMORY_OPERATING_MODE_CAPABILITY  MemoryOperatingModeCapability;
